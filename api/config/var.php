...
$this->config["tables"] = ['actions','agence','avis','billet','client','files','module','module_role','news','pays','post','reservation','roles','tarif','type_agent','users','ville',];
...
$this->config['tables']['client'] = ['id_client','nom','prenom','tel','email','fonction','nationalite',];

$this->config['tables']['actions']['id'] = ['id'];$this->config['tables']['agence']['id'] = ['id_agence'];$this->config['tables']['avis']['id'] = ['id_avis'];$this->config['tables']['billet']['id'] = ['id_billet'];$this->config['tables']['client']['id'] = ['id_client'];

$this->config['tables']['files'] = ['id','file_name','file_url','file_type','file_size',];

$this->config['tables']['actions']['id'] = ['id'];$this->config['tables']['agence']['id'] = ['id_agence'];$this->config['tables']['avis']['id'] = ['id_avis'];$this->config['tables']['billet']['id'] = ['id_billet'];$this->config['tables']['client']['id'] = ['id_client'];$this->config['tables']['files']['id'] = ['id'];

$this->config['tables']['module'] = ['id','name','icon','description','action_url','sub_module',];

$this->config['tables']['actions']['id'] = ['id'];$this->config['tables']['agence']['id'] = ['id_agence'];$this->config['tables']['avis']['id'] = ['id_avis'];$this->config['tables']['billet']['id'] = ['id_billet'];$this->config['tables']['client']['id'] = ['id_client'];$this->config['tables']['files']['id'] = ['id'];$this->config['tables']['module']['id'] = ['id'];

$this->config['tables']['module_role'] = ['id','role_id','module',];

$this->config['tables']['actions']['id'] = ['id'];$this->config['tables']['agence']['id'] = ['id_agence'];$this->config['tables']['avis']['id'] = ['id_avis'];$this->config['tables']['billet']['id'] = ['id_billet'];$this->config['tables']['client']['id'] = ['id_client'];$this->config['tables']['files']['id'] = ['id'];$this->config['tables']['module']['id'] = ['id'];$this->config['tables']['module_role']['id'] = ['id'];
