...
$this->config['tables']['agence'] = ['id_agence','code_agence','nom_agence','ville','file',];

$this->config['tables']['actions']['id'] = ['id'];$this->config['tables']['agence']['id'] = ['id_agence'];

$this->config['tables']['billet'] = ['id_billet','code_billet','created_at','user_create','depart_destination','bus',];
