...
$this->config["tables"] = ['actions','agence','avis','billet','bus','client','employes','files','garages','module','module_role','news','pays','post','reservation','roles','tarif','type_agent','users','ville',];
